...
from ansible_collections.ansible.cnos.plugins.modules import cnos_linkagg
...
class TestCnosLinkaggModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.ansible.cnos.plugins.modules.cnos_linkagg.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.ansible.cnos.plugins.modules.cnos_linkagg.load_config'
        )

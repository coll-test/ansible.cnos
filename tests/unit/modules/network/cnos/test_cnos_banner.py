...
from ansible_collections.ansible.cnos.plugins.modules import cnos_banner
...
class TestCnosBannerModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_banner.load_config')

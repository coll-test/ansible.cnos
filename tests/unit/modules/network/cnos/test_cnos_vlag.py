...
from ansible_collections.ansible.cnos.plugins.modules import cnos_vlag
...
class TestCnosVlagModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_cnos_commands = patch('ansible_collections.ansible.cnos.plugins.module_utils.network.cnos.cnos.run_cnos_commands')

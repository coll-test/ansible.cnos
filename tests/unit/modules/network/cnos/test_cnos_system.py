...
from ansible_collections.ansible.cnos.plugins.modules import cnos_system
...
class TestCnosSystemModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_system.load_config')

...
from ansible_collections.ansible.cnos.plugins.modules import cnos_vrf
...
class TestCnosVrfModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_vrf.run_commands')

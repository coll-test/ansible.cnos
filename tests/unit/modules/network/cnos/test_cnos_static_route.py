...
from ansible_collections.ansible.cnos.tests.unit.compat.mock import patch
from ansible_collections.ansible.cnos.plugins.modules import cnos_static_route
from ..cnos_module import TestCnosModule, load_fixture
from ansible_collections.ansible.cnos.tests.unit.modules.utils import set_module_args
...
class TestCnosStaticRouteModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_banner.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_static_route.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_static_route.get_config')

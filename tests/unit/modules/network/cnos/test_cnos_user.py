...
from ansible_collections.ansible.cnos.plugins.modules import cnos_user
...
class TestCnosUserModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_user.get_config')
        self.get_config = self.mock_get_config.start()
        self.mock_load_config = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_user.load_config')
        self.load_config = self.mock_load_config.start()
        self.mock_run_commands = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_user.run_commands')

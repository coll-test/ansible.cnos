...
from ansible_collections.ansible.cnos.plugins.modules import cnos_command
...
class TestCnosCommandModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.cnos.plugins.modules.cnos_command.run_commands')
